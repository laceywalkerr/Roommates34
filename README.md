...
1. Use the [Roommates](https://github.com/nashville-software-school/bangazon-inc/blob/cohort-43/book-1-orientation/chapters/assets/roommates.sql) SQL script to create a `Roommates` database.
1. Take a look at the ERD to familiarize yourself with the database.
![Roommates ERD](https://raw.githubusercontent.com/nashville-software-school/bangazon-inc/cohort-43/book-1-orientation/chapters/assets/Roommates.png)
